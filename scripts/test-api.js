...
async function testAPI() {
  ...
  const testEndpoints = [
    ...
    { method: 'POST', path: '/auth/send-otp', description: 'OTP sending endpoint' },
    { method: 'POST', path: '/auth/verify-otp', description: 'OTP verification endpoint' },
    { method: 'POST', path: '/auth/admin-login', description: 'Admin login endpoint' },
  ];
