...
requiredEnvVars.forEach(varName => {
  ...
  if (!value) {
    ...
    const maskedValue = varName.includes('SECRET') || varName.includes('PASSWORD') || varName.includes('API_KEY') 
...
if (process.env.NODE_ENV === 'production') {
  ...
  console.log(`⚠️  NODE_ENV: Set to "${process.env.NODE_ENV}" (should be "production" in live environment)`);
}
