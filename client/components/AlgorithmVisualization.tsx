...
export default function AlgorithmVisualization() {
  ...
  const getStepIcon = (id: string) => {
    switch (id) {
      ...
      case 'feature_extraction': return Brain;
      case 'attention_mechanism': return Network;
      case 'biomass_calculation': return Cpu;
      case 'blockchain_verification': return GitBranch;
      default: return Zap;
    }
  };
