...
import { AuthState, AuthUser, LoginResponse, OTPRequest, OTPVerification, AdminLoginRequest } from '@shared/auth';
...
export function AuthProvider({ children }: AuthProviderProps) {
  ...
  const adminLogin = async (data: AdminLoginRequest): Promise<LoginResponse> => {
    try {
      dispatch({ type: 'SET_LOADING', payload: true });
