      ...
      <section className="py-10">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <Card key={i} className="border-emerald-900/40 bg-slate-950/60 text-slate-100">
              <CardHeader className="pb-3">
                ...
                <CardTitle className="mt-3 text-white text-lg">{f.title}</CardTitle>
              </CardHeader>
              <CardContent className="text-slate-300 text-sm leading-relaxed">{f.desc}</CardContent>
            </Card>
          ))}
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            {[
              ...
              <Card key={i} className="overflow-hidden border-emerald-900/40 bg-slate-950/60">
