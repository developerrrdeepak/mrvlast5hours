      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Monitoring, Reporting & Verification tools for carbon credit projects
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-600">Satellite Updates</p>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-emerald-600">{carbonCredits.total.toFixed(1)}</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Live environmental data from field sensors</CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    {sensorData.slice(0, 1).map((data, index) => (
                      <div key={index} className="grid grid-cols-2 gap-4">
                        <div className="text-center p-3 bg-blue-50 rounded-lg">
                          ...
                          <p className="text-2xl font-bold text-blue-600">{data.temperature.toFixed(1)}°C</p>
                        </div>
                        <div className="text-center p-3 bg-green-50 rounded-lg">
                          <p className="text-sm text-gray-600">Humidity</p>
                          <p className="text-2xl font-bold text-green-600">{data.humidity.toFixed(0)}%</p>
                        </div>
                        <div className="text-center p-3 bg-amber-50 rounded-lg">
                          <p className="text-sm text-gray-600">Soil Moisture</p>
                          <p className="text-2xl font-bold text-amber-600">{data.soilMoisture.toFixed(0)}%</p>
                        </div>
                        <div className="text-center p-3 bg-purple-50 rounded-lg">
                          <p className="text-sm text-gray-600">Soil pH</p>
                          <p className="text-2xl font-bold text-purple-600">{data.ph.toFixed(1)}</p>
                        </div>
                      </div>
                    ))}
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Remote sensing data analysis</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="grid grid-cols-3 gap-4">
                      <div className="text-center p-3 bg-green-50 rounded-lg">
                        ...
                        <p className="text-2xl font-bold text-green-600">{satelliteData.ndvi.toFixed(2)}</p>
                      </div>
                      <div className="text-center p-3 bg-blue-50 rounded-lg">
                        <p className="text-sm text-gray-600">Canopy Cover</p>
                        <p className="text-2xl font-bold text-blue-600">{satelliteData.canopyCover.toFixed(0)}%</p>
                      </div>
                      <div className="text-center p-3 bg-emerald-50 rounded-lg">
                        <p className="text-sm text-gray-600">Biomass</p>
                        <p className="text-2xl font-bold text-emerald-600">{satelliteData.biomass.toFixed(1)} t/ha</p>
                      </div>
                    </div>
                    <div className="flex justify-between items-center pt-2">
                      <span className="text-xs text-gray-500">
                        Last updated: {satelliteData.captureDate.toLocaleString()}
                      </span>
              ...
              <Card className="lg:col-span-2">
                <CardHeader>
                  ...
                  <CardDescription>Register new farm for monitoring</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input 
                        ...
                        onChange={(e) => setFarmData({...farmData, farmerId: e.target.value})}
                  ...
                  <div className="flex justify-end mt-4 space-x-2">
                    <Button onClick={calculateCarbonCredits} className="bg-green-600 hover:bg-green-700">
                      Calculate Credits
                    </Button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Total Credits Generated</span>
                      <span className="font-bold text-green-600">{carbonCredits.total.toFixed(1)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Verified Credits</span>
                      <span className="font-bold text-blue-600">{carbonCredits.verified.toFixed(1)}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600">Pending Verification</span>
                      <span className="font-bold text-amber-600">{carbonCredits.pending.toFixed(1)}</span>
                    </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Download MRV reports in various formats</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <Button variant="outline" className="w-full justify-start" onClick={() => exportReport('Carbon Credit')}>
                      <Download className="h-4 w-4 mr-2" />
                      Carbon Credit Report (PDF)
                    </Button>
                    <Button variant="outline" className="w-full justify-start" onClick={() => exportReport('Monitoring')}>
                      <Download className="h-4 w-4 mr-2" />
                      Monitoring Data (Excel)
                    </Button>
                    <Button variant="outline" className="w-full justify-start" onClick={() => exportReport('Verification')}>
                      <Download className="h-4 w-4 mr-2" />
                      Verification Report (PDF)
                    </Button>
                    <Button variant="outline" className="w-full justify-start" onClick={() => exportReport('Financial')}>
                      <Download className="h-4 w-4 mr-2" />
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-3 bg-green-50 rounded-lg">
                      ...
                      <div>
                        <p className="font-medium">Farm ID-1234 verification completed</p>
                    ...
                    <div className="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg">
                      ...
                      <div>
                        <p className="font-medium">Satellite data updated for 45 farms</p>
                    ...
                    <div className="flex items-center space-x-3 p-3 bg-amber-50 rounded-lg">
                      ...
                      <div>
                        <p className="font-medium">Pending verification for Farm ID-5678</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <span className="text-sm text-gray-600">{verificationProgress().toFixed(0)}%</span>
                    </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Automated verification systems</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
          ...
          <TabsContent value="calculator">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Calculate potential carbon credits and income</CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="p-4 bg-green-50 rounded-lg">
                        <p className="text-sm text-gray-600">Annual Carbon Credits</p>
                        <p className="text-2xl font-bold text-green-600">25.5 tCO2</p>
                      </div>
                      <div className="p-4 bg-blue-50 rounded-lg">
                        <p className="text-sm text-gray-600">Total Project Credits</p>
                        <p className="text-2xl font-bold text-blue-600">255 tCO2</p>
                      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Farmer-friendly mobile tools</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Developer resources and endpoints</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3">
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <code className="text-sm">GET /api/sensors/:farmId</code>
                      <p className="text-xs text-gray-600 mt-1">Retrieve sensor data</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <code className="text-sm">POST /api/satellite/analyze</code>
                      <p className="text-xs text-gray-600 mt-1">Request satellite analysis</p>
                    </div>
                    <div className="p-3 bg-gray-50 rounded-lg">
                      <code className="text-sm">GET /api/credits/:farmId</code>
                      <p className="text-xs text-gray-600 mt-1">Calculate carbon credits</p>
                    </div>
